...
**Tech Stack:** Rust 1.86+, Pest, Tokio, Wasmtime, wasm-encoder, Cranelift, LLVM behind an optional backend, Serde/TOML, Salsa-style incremental queries, Tower/LSP, Ed25519 signatures, OpenTelemetry, Cargo workspace tooling.
